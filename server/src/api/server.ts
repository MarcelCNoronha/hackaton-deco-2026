...
import { generatedImagesPublicRoutes } from "./routes/generated-images-public.routes.js";
import { generatedVideosPublicRoutes } from "./routes/generated-videos-public.routes.js";
...
import { pdpTemplatesRoutes } from "./routes/pdp-templates.routes.js";
import { pageContentRoutes } from "./routes/page-content.routes.js";
import { pageImpactRoutes } from "./routes/page-impact.routes.js";
...
import { businessImpactRoutes } from "./routes/business-impact.routes.js";
...
await app.register(generatedImagesPublicRoutes);
await app.register(generatedVideosPublicRoutes);
...
await app.register(pdpTemplatesRoutes);
await app.register(pageContentRoutes);
await app.register(pageImpactRoutes);
await app.register(categoryProfilesRoutes);
await app.register(catalogRoutes);
await app.register(spendLimitsRoutes);
await app.register(businessImpactRoutes);
